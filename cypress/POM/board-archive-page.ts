    ...
    constructor() {
        ...
        this.elements = {
            ...
            createBoardModal: {
                ...
                createButton: () =>
                    cy.get('.chakra-button.css-1h7v26a:contains("Create")')
            }
        };
        this.actions = {
            ...
            createBoardModal: {
                typeBoardName: (boardName) =>
                    this.elements.createBoardModal
                        .boardNameInputField()
                        .type(boardName),
                clearBoardName: () =>
                    this.elements.createBoardModal.boardNameInputField().clear(),
                clickOnCloseModalButton: () =>
                    this.elements.createBoardModal.closeButton().click(),
                clickOnCreateButton: () =>
                    this.elements.createBoardModal.createButton().click()
            }
        };
    }
}
